...
const qualifications = [
    {
        ...
        institution: "Bharat Institute of Technology, Meerut (AKTU)",
        year: "2023 – 2027",
        description: "CGPA: 8.1 | Focused on Frontend Development, Data Structures, and Algorithms. Active in hackathons and tech events.",
        icon: <BookOpen className="w-6 h-6" />
    },
    {
        id: 2,
        title: "Frontend Development",
        institution: "React · Tailwind CSS · Bootstrap · Javscript · HTML · CSS",
        year: "Frameworks",
        description: "Building responsive, modern web apps using React.js with component-based architecture. Skilled in Tailwind CSS and Bootstrap for rapid, consistent UI development.",
        icon: <Hexagon className="w-6 h-6" />
    },
    {
        id: 3,
        title: "Problem Solving",
        institution: "LeetCode · JavaScript · C++ ·Pyhton",
        year: "Competitive",
        description: "Active problem solver on LeetCode and regular contest participant with strong interest in competitive programming. Proficient in JavaScript, C++ and Pyhton.",
